...
urlpatterns = patterns('',
    ...
    url('^(\w+)/shop/(\d{1,2})/$',shopDetail_JsonXml,name='shopdetailJsonXml'),
    url('^game/(\d{1,2})/$',gameDetail,name='gamedetail'),
    url('^(\w+)/game/(\d{1,2})/$',gameDetail_JsonXml,name='gamedetailJsonXml'),
    url('^producer/(\d{1,2})/$',producerDetail,name='producerDetail'),
    url('^(\w+)/producer/(\d{1,2})/$',producerDetail_JsonXml,name='producerdetailJsonXml'),
)
