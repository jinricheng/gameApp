...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Game.nif'
        db.delete_column(u'igame_game', 'nif')

        # Adding field 'Game.gameCode'
        db.add_column(u'igame_game', 'gameCode',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Game.nif'
        db.add_column(u'igame_game', 'nif',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)

        # Deleting field 'Game.gameCode'
        db.delete_column(u'igame_game', 'gameCode')
