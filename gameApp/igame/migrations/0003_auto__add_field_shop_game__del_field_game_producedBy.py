...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Shop.game'
        db.add_column(u'igame_shop', 'game',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='shops', null=True, to=orm['igame.Game']),
                      keep_default=False)

        # Deleting field 'Game.producedBy'
        db.delete_column(u'igame_game', 'producedBy_id')
    ...
    def backwards(self, orm):
        # Deleting field 'Shop.game'
        db.delete_column(u'igame_shop', 'game_id')


        # User chose to not deal with backwards NULL issues for 'Game.producedBy'
        raise RuntimeError("Cannot reverse this migration. 'Game.producedBy' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Game.producedBy'
        db.add_column(u'igame_game', 'producedBy',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['igame.Producer']),
                      keep_default=False)
