...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Game.city'
        db.delete_column(u'igame_game', 'city')

        # Deleting field 'Game.country'
        db.delete_column(u'igame_game', 'country')


    def backwards(self, orm):
        # Adding field 'Game.city'
        db.add_column(u'igame_game', 'city',
                      self.gf('django.db.models.fields.TextField')(default=' '),
                      keep_default=False)

        # Adding field 'Game.country'
        db.add_column(u'igame_game', 'country',
