...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Shop.nif'
        db.delete_column(u'igame_shop', 'nif')

        # Adding field 'Shop.cif'
        db.add_column(u'igame_shop', 'cif',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Shop.nif'
        db.add_column(u'igame_shop', 'nif',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)

        # Deleting field 'Shop.cif'
        db.delete_column(u'igame_shop', 'cif')
