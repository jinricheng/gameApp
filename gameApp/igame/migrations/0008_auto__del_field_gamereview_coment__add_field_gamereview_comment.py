...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'gameReview.coment'
        db.delete_column(u'igame_gamereview', 'coment')

        # Adding field 'gameReview.comment'
        db.add_column(u'igame_gamereview', 'comment',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'gameReview.coment'
        db.add_column(u'igame_gamereview', 'coment',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'gameReview.comment'
        db.delete_column(u'igame_gamereview', 'comment')
